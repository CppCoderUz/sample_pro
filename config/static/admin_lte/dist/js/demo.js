...
(function ($) {
  ...
  setTimeout(function () {
    var item = localStorage.getItem("dark_mode");
    if (item === "true") {
      document.body.classList.add("dark-mode");
      document.getElementsByTagName("nav")[0].classList.add("bg-dark");
      document.getElementById("icon_mode").setAttribute("class", "fas fa-light fa-sun");
    }
  })

  $("#icon_mode").click(function(){
    set_mode();
  })
  ...
  function set_mode() {
    ...
    if (mode === "true") {
      ...
      icon.setAttribute("class", "fas fa-light fa-moon");
      document.body.setAttribute("class", "hold-transition sidebar-mini layout-fixed");
      document.getElementsByTagName("nav")[0].setAttribute("class", "main-header navbar navbar-expand navbar-white navbar-light");
     } else {
      localStorage.setItem("dark_mode", "true");
      icon.setAttribute("class", "fas fa-light fa-sun");
      document.body.classList.add("dark-mode");
      document.getElementsByTagName("nav")[0].classList.add("bg-dark");
     }
  }
